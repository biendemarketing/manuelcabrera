        ...
        <div className="fixed inset-0 z-[120] flex flex-col bg-black/95 backdrop-blur-2xl text-white">
          <div className="flex items-center justify-between px-4 sm:px-8 py-3 bg-zinc-950/80 border-b border-zinc-800 z-20">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 rounded-xl bg-zinc-900 border border-zinc-700 text-zinc-300 hover:text-white"
              >
                {isZoomed ? <Minimize2 className="w-4 h-4" /> : <Maximize2 className="w-4 h-4" />}
              </button>
              <button
                onClick={() => setLightboxIndex(null)}
                className="p-2 rounded-xl bg-zinc-800 border border-zinc-600 text-zinc-300 hover:text-white"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="relative flex-1 flex items-center justify-center p-4">
            <button
              ...
              className="absolute left-4 z-30 p-3 rounded-2xl bg-zinc-900/80 hover:bg-indigo-600 text-white border border-zinc-700"
            >
              <ChevronLeft className="w-6 h-6" />
            </button>
            <button
              onClick={() => setLightboxIndex((prev) => (prev !== null ? (prev + 1) % RECOPILACION_SLIDES.length : 0))}
              className="absolute right-4 z-30 p-3 rounded-2xl bg-zinc-900/80 hover:bg-indigo-600 text-white border border-zinc-700"
            >
