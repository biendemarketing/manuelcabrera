...
export const metadata: Metadata = {
  ...
  keywords: [
    // ── 1. Marketing Digital & Publicidad (Español & English) ──
    'marketing digital',
    ...
    // ── 2. Diseño Gráfico, Branding & Packaging ──
    'diseño gráfico',
    'diseñador gráfico',
    'diseño de logos',
    'diseño de logotipo',
    ...
    // ── 3. Desarrollo Web, Software & UI/UX ──
    'desarrollo web',
    'diseño web',
    ...
    'solicitar presupuesto diseño web',
    'web development',
    'web design',
    'website design',
    'website development',
    ...
    // ── 4. Automatizaciones & Integraciones ──
    ...
    // ── 5. Inteligencia Artificial & Modelos Generativos ──
    ...
    // ── 6. Fotografía, Video & Producción Audiovisual ──
    ...
    // ── 7. Imprenta, Gran Formato, Rótulos & 3D ──
    'imprenta punta cana',
    'impresión gran formato punta cana',
    'rotulación de vinil',
    ...
    'render 3d de productos',

    // ── 8. Geolocalización: República Dominicana (Punta Cana + Provincias Clave) ──
    'marketing digital República Dominicana',
    'agencia de marketing digital República Dominicana',
    'marketing digital Punta Cana',
    'agencia de marketing Punta Cana',
    'marketing digital Santo Domingo',
    'agencia de marketing Santo Domingo',
    'marketing digital Santiago',
    'diseño gráfico República Dominicana',
    'diseñador gráfico Punta Cana',
    'diseñador gráfico Santo Domingo',
    'diseñador gráfico Santiago',
    ...
    'agencia de publicidad Santo Domingo',
    'agencia de publicidad Punta Cana',
    'agencia creativa Santo Domingo',
    'agencia creativa Punta Cana',
    'fotografía profesional Santo Domingo',
    'fotógrafo profesional Punta Cana',
    'producción audiovisual Santo Domingo',
    'producción audiovisual Punta Cana',
    'automatización empresarial República Dominicana',
    'inteligencia artificial para empresas República Dominicana',
    'agencia digital República Dominicana',
    'Punta Cana',
    'Bávaro',
    'Verón',
    'Cap Cana',
    ...
    'Manuel Cabrera',
    'Manuel Cabrera Director Creativo',
  ],
