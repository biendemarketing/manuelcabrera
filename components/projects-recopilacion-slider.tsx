...
export function ProjectsRecopilacionSlider() {
  ...
  return (
    <BlurFadeSection 
      ...
      className="py-12 sm:py-16 bg-zinc-950 text-white relative w-full border-b border-zinc-800/80 overflow-hidden"
    >
      {/* Background Ambient Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[1000px] h-[350px] bg-indigo-600/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="w-full px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative z-10">
        ...
        <div 
          className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-zinc-950 border border-zinc-800 shadow-2xl group"
          onMouseEnter={() => setIsHovered(true)}
          onMouseLeave={() => setIsHovered(false)}
        >
          {/* BARRA DE CARGA (PROGRESS BAR) */}
          <div className="w-full h-1 bg-zinc-900/90 relative overflow-hidden z-30">
            <div 
          ...
          <div className="relative aspect-[16/9] w-full bg-zinc-950 flex items-center justify-center overflow-hidden">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-30 p-2.5 sm:p-3.5 rounded-xl sm:rounded-2xl bg-zinc-900/75 hover:bg-indigo-600 text-white border border-zinc-700/80 backdrop-blur-md shadow-xl transition-all duration-150 hover:scale-110 active:scale-95 opacity-75 group-hover:opacity-100"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-30 p-2.5 sm:p-3.5 rounded-xl sm:rounded-2xl bg-zinc-900/75 hover:bg-indigo-600 text-white border border-zinc-700/80 backdrop-blur-md shadow-xl transition-all duration-150 hover:scale-110 active:scale-95 opacity-75 group-hover:opacity-100"
